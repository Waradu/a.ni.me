<template>
  <div class="select">
    ...
    <div class="animes">
      <label class="anime" v-for="anime in animes" :key="anime.id" :for="anime.id.toString()">
        <div class="cover">
        ...
        <input type="checkbox" :id="anime.id.toString()" :name="anime.id.toString()" :value="anime.id"
